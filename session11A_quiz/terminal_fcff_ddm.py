...
def terminal_fcff_ddm(
    ...
    fcff = exp_net_income * (1 - reinvestment_rate) / (terminal_coe - terminal_growth_rate)
    return fcff

if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(
        description="Terminal value of FCFF after some number of years using " +
    ...
    print(terminal_fcff_ddm(args.dividend, args.net_income, args.terminal_roe,
